...
function findFiles(projectPath, predicate, maxDepth = 6) {
    const found = [];
    const walk = (currentPath, depth) => {
        ...
        for (const entry of entries) {
            if (["node_modules", "vendor", ".git", "build", "dist"].includes(entry.name))
                continue;
...
export class ShellCheck {
    name;
    command;
    args;
    unavailableMessage;
    constructor(name, command, args, unavailableMessage) {
        this.name = name;
...
export const composerValidation = () => new ShellCheck("Composer Validation", commandName("composer"), ["validate", "--no-check-publish"]);
export const phpVersionCheck = () => new ShellCheck("PHP Version", commandName("php"), ["-v"]);
export const phpSyntaxCheck = () => new ValidationCheck("PHP Syntax", async (projectPath) => {
...
export const artisanCheck = () => new ValidationCheck("Artisan Check", (projectPath) => ({
    ok: exists(projectPath, "artisan"),
    message: exists(projectPath, "artisan") ? "artisan found" : "artisan file not found",
}));
export const laravelRouteCheck = () => new ShellCheck("Route Check", commandName("php"), ["artisan", "route:list"]);
export const bladeValidation = () => new ValidationCheck("Blade Validation", (projectPath) => {
...
export const publicFolderCheck = () => new ValidationCheck("Public Folder Check", (projectPath) => ({
...
export const storagePermissionCheck = () => new ValidationCheck("Storage Permission Check", (projectPath) => {
...
export const themeValidation = () => new ValidationCheck("Theme Validation", (projectPath) => ({
...
export const pluginValidation = () => new ValidationCheck("Plugin Validation", (projectPath) => ({
...
export const htmlValidation = () => new ValidationCheck("HTML Validation", (projectPath) => {
...
export const cssValidation = () => new ValidationCheck("CSS Validation", (projectPath) => {
...
export const flutterDoctor = () => new ShellCheck("flutter doctor", commandName("flutter"), ["doctor"]);
export const pubspecValidation = () => new ShellCheck("pubspec.yaml validation", commandName("flutter"), ["pub", "get", "--dry-run"]);
export const dartAnalyze = () => new ShellCheck("dart analyze", commandName("dart"), ["analyze"]);
export const flutterTest = () => new ShellCheck("flutter test", commandName("flutter"), ["test"]);
export const dependencyValidation = () => new ValidationCheck("dependency validation", (projectPath) => ({
...
export const assetValidation = () => new ValidationCheck("Asset Validation", (projectPath) => {
...
export const metroValidation = () => new ValidationCheck("Metro Validation", (projectPath) => ({
...
export const androidValidation = () => new ValidationCheck("Android Validation", (projectPath) => ({
    ok: exists(projectPath, "android"),
    message: exists(projectPath, "android") ? "Android project found" : "Android folder not found",
}));
export const iosValidation = () => new ValidationCheck("iOS Validation", (projectPath) => ({
    ok: exists(projectPath, "ios"),
    message: exists(projectPath, "ios") ? "iOS project found" : "iOS folder not found",
}));
export const swiftBuild = () => new ShellCheck("Swift Build", commandName("swift"), ["build"]);
export const swiftLint = () => new ShellCheck("SwiftLint", commandName("swiftlint"), []);
export const packageValidation = () => new ValidationCheck("Package Validation", (projectPath) => ({
